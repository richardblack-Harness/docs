...
<AccordionGroup>
<Accordion title="What versions will Harness support in the future? How will it be maintained?">
...
<Accordion title="What about Kubernetes clusters that are managed on-prem and are self-maintained by customers?">
...
<Accordion title="What exactly does it mean to ‘support’ a Kubernetes version?">
...
<Accordion title="Does Harness use SDKs for the cloud vendors?">
...
For further details or assistance, please contact [Harness Support](https://developer.harness.io/docs/continuous-delivery/).
