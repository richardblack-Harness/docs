...
In Harness, you can [create triggers](../pipelines/code-triggers.mdx) to automatically run your CI/CD pipelines in response to push events in your Harness Code repos. You don't need to create a webhook to do this.
