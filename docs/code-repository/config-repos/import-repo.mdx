...
You can [create repositories directly in Harness Code](create-repo.mdx) or import repositories from other Git SCM providers, such as GitHub, GitLab, BitBucket, and more. 
...
* [Configure branch rules](rules.mdx) and [access control](/docs/code-repository/get-started/onboarding-guide.md#manage-access).
* Use Harness Code repositories in your [Harness pipelines](../pipelines/codebase-from-harness-code.mdx).
* Set up [triggers](../pipelines/code-triggers.mdx) to automatically run pipelines based on activity in your Harness Code repositories.
* [Configure webhooks](webhooks.mdx) to integrate your repositories with third-party applications.
