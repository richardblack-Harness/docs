...
For information about branch rules, go to [Enable branch rules](../config-repos/rules.mdx).
...
You can [enable branch rules](../config-repos/rules.mdx) to automatically delete branches when PRs are merged.
