...
* Learn about the [Harness Code key concepts](key-concepts.mdx).
...
* [Mirror repos](../config-repos/mirror.mdx) in any SCM provider.
...
[Configure your pipelines to build, test, and deploy code from your Harness Code repos.](../pipelines/codebase-from-harness-code.mdx)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/SaH27_UgAxA" title="Access control with Harness Code" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
