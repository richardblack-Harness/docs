...
* [Get Started with Harness Code](onboarding-guide.mdx)
...
### Pipelines
You can use [triggers](../pipelines/code-triggers.mdx) to run Harness pipelines in response to push events in your Harness Code repositories.
