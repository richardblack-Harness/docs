---
title: "Best Practices for AI Command Types"
description: "This guide outlines the four primary AI command types used in our testing framework, along with detailed explanations and best practices for each type."
---
