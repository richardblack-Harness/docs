...
After [creating a repository](../config-repos/create-repo.mdx), you can work directly in the Harness Code UI or you can clone your repo to your local machine and use your favorite IDE.
